...
if (WINDOWS)
  ...
  elseif (WORD_SIZE EQUAL 64)
    if (RELEASE_FULL_OPT AND NOT INCREMENTAL_LINK)
      set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} /OPT:REF,ICF /LTCG")
      set(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} /OPT:REF,ICF /LTCG")
      set(CMAKE_STATIC_LINKER_FLAGS "${CMAKE_STATIC_LINKER_FLAGS} /LTCG")
    elseif(NOT INCREMENTAL_LINK)
      set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} /OPT:REF /INCREMENTAL:NO")
      set(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} /OPT:REF /INCREMENTAL:NO")
    endif (RELEASE_FULL_OPT AND NOT INCREMENTAL_LINK)
  endif (WORD_SIZE EQUAL 32)

  if (INCREMENTAL_LINK AND NOT RELEASE_FULL_OPT)
  ...
  endif (INCREMENTAL_LINK AND NOT RELEASE_FULL_OPT)
