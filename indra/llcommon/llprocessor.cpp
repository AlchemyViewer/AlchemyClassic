...
class LLProcessorInfoWindowsImpl final : public LLProcessorInfoImpl
{
public:
...
private:
	...
	std::tuple<int, int, int, int> computeFamilyAndModel(
	...
	void getCPUIDInfo()
	{
		...
		static constexpr int paramStart = 0x80000002;
		static constexpr int paramEnd = 0x80000004;
		static constexpr int kParameterSize = paramEnd - paramStart + 1;
