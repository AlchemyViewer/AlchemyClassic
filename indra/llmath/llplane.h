...
static_assert(std::is_trivial<LLPlane>{}, "LLPlane must be a trivial type");
static_assert(std::is_standard_layout<LLPlane>{}, "LLPlane must be a standard layout type");
