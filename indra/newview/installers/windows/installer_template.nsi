...
;Version Information
  ...
  VIAddVersionKey /LANG=${LANG_ENGLISH} "CompanyName" "Alchemy Development Group"
  VIAddVersionKey /LANG=${LANG_ENGLISH} "LegalCopyright" "Copyright (c) 2013-2020, Alchemy Development Group"
