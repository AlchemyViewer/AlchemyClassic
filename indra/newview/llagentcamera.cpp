...
constexpr F32 CAMERA_ZOOM_HALF_LIFE = 0.07f;	// seconds
constexpr F32 FOV_ZOOM_HALF_LIFE = 0.07f;	// seconds
...
constexpr F32 MAX_CAMERA_SMOOTH_DISTANCE = 50.0f;

constexpr F32 HEAD_BUFFER_SIZE = 0.3f;

constexpr F32 CUSTOMIZE_AVATAR_CAMERA_ANIM_SLOP = 0.1f;
...
constexpr F32 CUSTOMIZE_AVATAR_CAMERA_DEFAULT_DIST = 3.5f;
