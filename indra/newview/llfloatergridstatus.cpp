...
void LLFloaterGridStatus::getGridStatusRSSCoro()
{
	...
	auto httpAdapter = std::make_shared<LLCoreHttpUtil::HttpCoroutineAdapter>("getGridStatusRSSCoro", httpPolicy);
    ...
    std::string fullpath = gDirUtilp->getExpandedFilename(LL_PATH_CACHE,"grid_status_rss.xml");
