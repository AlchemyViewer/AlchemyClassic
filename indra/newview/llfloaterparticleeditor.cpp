...
LLFloaterParticleEditor::~LLFloaterParticleEditor()
{
	clearParticles();
}

BOOL LLFloaterParticleEditor::postBuild()
{
...
void LLFloaterParticleEditor::updateParticles()
{
	if (!mObject)
		return;
...
void LLFloaterParticleEditor::setObject(LLViewerObject* objectp)
{
	if (objectp)
	{
		mObject = objectp;
...
void LLFloaterParticleEditor::updateUI()
{
...
void LLFloaterParticleEditor::onClickClearTarget()
{
	mTargetKeyInput->clear();
	onParameterChange();
}

void LLFloaterParticleEditor::onClickTargetPicker()
{
...
// static
void LLFloaterParticleEditor::onTargetPicked(void* userdata)
{
...
std::string LLFloaterParticleEditor::createScript()
{
	std::string script(
"\
default\n\
...
void LLFloaterParticleEditor::callbackReturned(const LLUUID& inventoryItemID)
{
	setCanClose(TRUE);
...
void LLFloaterParticleEditor::LLParticleScriptCreationCallback::fire(const LLUUID& inventoryItem)
{
