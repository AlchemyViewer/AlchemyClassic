...
#ifndef LL_PANELMENUBARPULLDOWN_H
#define LL_PANELMENUBARPULLDOWN_H

#include "llpanel.h"

class LLFrameTimer;

class LLPanelMenuBarPulldown : public LLPanel
{
public:
...
#endif // LL_PANELMENUBARPULLDOWN_H
