...
// [SL:KB] - Patch: Appearance-DnDWear | Checked: 2010-09-28 (Catznip-2.2)
			...
			LLPointer<LLInventoryCallback> cb = new LLBoostFuncInventoryCallback(boost::bind(rez_attachment_cb, _1, (LLViewerJointAttachment*)nullptr, fReplace));
// [/SL:KB]
			copy_inventory_item(
				gAgent.getID(),
...
// [SL:KB] - Patch: Appearance-DnDWear | Checked: 2010-09-28 (Catznip-2.2)
			// Make this behave consistent with dad3dWearItem
			rez_attachment(item, nullptr, !(mask & MASK_CONTROL));
// [/SL:KB]
