...
#endif
S16  LLViewerTexture::sCameraMovingDiscardBias = 0;
...
#if ADDRESS_SIZE == 32
const S32 DESIRED_NORMAL_TEXTURE_SIZE = LLViewerFetchedTexture::MAX_IMAGE_SIZE_DEFAULT / 2;
#else
const S32 DESIRED_NORMAL_TEXTURE_SIZE = LLViewerFetchedTexture::MAX_IMAGE_SIZE_DEFAULT;
#endif
