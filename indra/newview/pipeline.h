...
// 	bool		isLocalLightingEnabled() const;
	...
	void updateCull(LLCamera& camera, LLCullResult& result, S32 water_clip = 0, LLPlane* plane = nullptr, bool hud_attachments = false);  //if water_clip is 0, ignore water plane, 1, cull to above plane, -1, cull to below plane
	...
	static bool toggleRenderTypeControlNegated(U32 data);
